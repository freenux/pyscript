...
# 1. 导出没有归因数据的神策用户
echo "Start to export no campaign users from sensor"
...
# 2. 查询归因数据
echo "Start to query campaign data"
